    ...
    <div className="max-w-3xl mx-auto bg-white rounded-[32px] border border-gray-100 shadow-2xl overflow-hidden mb-10">
      ...
      <div className="bg-gray-900 p-8 text-center relative overflow-hidden">
        ...
        >
          ...
          <span className="text-[10px] font-black uppercase tracking-widest hidden md:block">Back to List</span>
        </button>
        <h2 className="text-3xl font-black text-white tracking-tight relative z-10 uppercase">Visitor Registration</h2>
        <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.3em] mt-2 relative z-10">Digital Entry Portal</p>
      </div>
      ...
      <div className="p-6 md:p-10 space-y-8">
        {step === "FORM" ? (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-4">
              <label className="text-[11px] font-black text-orange-500 uppercase tracking-[0.2em] flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
                <div className="relative group">
                  ...
                  />
                  <button onClick={handleSearch} className="absolute right-2 top-2 bottom-2 px-4 bg-gray-900 text-white rounded-xl text-[10px] font-black uppercase tracking-widest">
              ...
              {status !== "idle" && (
                <div className={`px-4 py-2 rounded-xl inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-tighter ${status === 'found' ? 'bg-green-50 text-green-700 border border-green-100' : 'bg-yellow-50 text-yellow-700 border border-yellow-100'}`}>
            ...
            {/* Personal Details */}
            <div className="space-y-4">
              <label className="text-[11px] font-black text-orange-500 uppercase tracking-[0.2em]">Personal Details</label>
            ...
            <div className="space-y-4 pt-2">
              <label className="text-[11px] font-black text-orange-500 uppercase tracking-[0.2em]">Visit Information</label>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="py-10 text-center space-y-6 animate-in zoom-in-95 duration-300">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-black text-gray-900 uppercase tracking-tighter">Security Verification</h3>
              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">6-Digit code sent to <span className="text-gray-900">+{mobile}</span></p>
            </div>
            <div className="max-w-[320px] mx-auto space-y-4">
              <input 
                className="w-full bg-gray-50 border-none ring-1 ring-orange-200 focus:ring-2 focus:ring-orange-500 p-5 text-center text-3xl font-black tracking-[0.3em] rounded-3xl" 
                maxLength={6}
                value={otp} 
        ...
        <button
          ...
          disabled={loading}
          className="w-full group bg-gray-900 hover:bg-orange-600 text-white p-5 rounded-2xl font-black uppercase tracking-widest text-[11px] flex items-center justify-center gap-3 transition-all duration-500 shadow-xl shadow-black/10 active:scale-[0.98] disabled:opacity-50"
        >
          {loading ? (
